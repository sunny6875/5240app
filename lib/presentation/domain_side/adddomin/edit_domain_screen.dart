...
import 'package:project_5240_frontend/presentation/domain_side/adddomin/controller/edit_domain_controller.dart';
...
class EditDomainScreen extends StatelessWidget {
  bool? afterLoginAddDomain;
  EditDomainScreen({this.afterLoginAddDomain}) : super();
  EditDomainController controller = Get.put(EditDomainController());

  DomainidController domainidController = Get.find<DomainidController>();

  @override
  Widget build(BuildContext context) {
    return GetBuilder<EditDomainController>(builder: (editDomainController) {
      return Scaffold(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  const CustomTextView(
                    "Name and Photos of your domain",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontSize: 16,
                        color: AppColors.black,
                  ...
                  customTextField(
                    controller: editDomainController.titleController,
                    onChanged: (value) =>
                        editDomainController.title.value = value,
                    title: "Name",
                  ),
                  // const SizedBox(height: 20),
                  // customTextField(
  ...
  Widget uploadPhotosWidget() {
    return GetBuilder<EditDomainController>(builder: (controller) {
      return Padding(
        padding: const EdgeInsets.symmetric(horizontal: 25),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget btnWidget() {
    return Obx(() => GestureDetector(
          onTap: () {
            controller
                .editDomain(title: controller.titleController.text)
                .then((value) {
              if (value == true) {
                Get.back();
              }
